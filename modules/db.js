let movies = [
    ...
    },
    {
        ...
        "Writer": "Edgar Wright (screenplay by), Joe Cornish (screenplay by), Adam McKay (screenplay by), Paul Rudd (screenplay by), Edgar Wright (story by), Joe Cornish (story by), Stan Lee (based on the Marvel comics by), Larry Lieber (based on the Marvel comics by), Jack Kirby (based on the Marvel comics by)",
        "Actors": "Paul Rudd, Michael Douglas, Evangeline Lilly, Corey Stoll",
        "Plot": "Майкл Морбиус с детства страдает от редкого заболевания крови и всю свою сознательную жизнь посвятил поискам лекарства. В какой-то момент Майкл видит возможное...",
        "Language": "English",
        "Country": "USA",
        "Awards": "Nominated for 1 BAFTA Film Award. Another 4 wins & 33 nominations.",
        "Poster": "https://kinohit.uz/uploads/posts/2021-05/1620659293_300x450-58.jpg",
        "Ratings": [{
                "Source": "Internet Movie Database",
                "Value": "4.9/10"
            },
    ...
    },
    {
        ...
        "Writer": "Edgar Wright (screenplay by), Joe Cornish (screenplay by), Adam McKay (screenplay by), Paul Rudd (screenplay by), Edgar Wright (story by), Joe Cornish (story by), Stan Lee (based on the Marvel comics by), Larry Lieber (based on the Marvel comics by), Jack Kirby (based on the Marvel comics by)",
        "Actors": "Paul Rudd, Michael Douglas, Evangeline Lilly, Corey Stoll",
        "Plot": "Алекс Льюис, профессиональный киллер с репутацией, в какой-то момент пошел против ветра, и теперь вынужден отбиваться и от ФБР, и от криминального босса. Все потому, что убийца отказался нарушить свой внутренний кодекс....",
        "Language": "English",
        "Country": "USA",
        "Awards": "Nominated for 1 BAFTA Film Award. Another 4 wins & 33 nominations.",
        "Poster": "https://kinohit.uz/uploads/posts/2022-03/1648741196_300x450-3.jpeg",
        "Ratings": [{
                "Source": "Internet Movie Database",
                "Value": "4.9/10"
            },
